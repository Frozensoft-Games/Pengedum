...
class I18n
{
    ...
    private static void LoadLanguage()
    {
        ...
        Fields.Clear();
        var lang = Get2LetterISOCodeFromSystemLanguage().ToLower();
        //lang = "no"; // Used to select other languages, used for testing. (Should be commented out for publish builds.
        ...
        var allTexts = (textAsset as TextAsset)?.text;
